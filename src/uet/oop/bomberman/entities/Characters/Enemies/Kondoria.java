...
import uet.oop.bomberman.entities.Characters.AI.AIHigh;
...
public class Kondoria extends Enemy {
    ...
    protected void chooseSprite() {
        ...
        Sprite defaultSprite = (directionGroup == DirectionGroup.RIGHT) ? Sprite.kondoria_right1 : Sprite.kondoria_left1;

        // Sprites for moving state
        if (moving) {
            if (directionGroup == DirectionGroup.RIGHT) {
                sprite = Sprite.movingSprite(Sprite.kondoria_right1, Sprite.kondoria_right2, Sprite.kondoria_right3, animate, ANIMATION_FRAME_DURATION);
            } else {
                sprite = Sprite.movingSprite(Sprite.kondoria_left1, Sprite.kondoria_left2, Sprite.kondoria_left3, animate, ANIMATION_FRAME_DURATION);
            }
        } else {
